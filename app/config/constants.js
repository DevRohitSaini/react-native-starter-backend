...
const environmentConfigs = {
  development: {
    mongo: {
      uri: process.env.MONGO_URI || 'mongodb://0.0.0.0:27017/react-native-starter-api',
    },
    security: {
      saltRounds: 4,
    },
  ...
  test: {
    port: 5678,
    mongo: {
      uri: process.env.MONGO_URI || 'mongodb://0.0.0.0:27017/test-react-native-starter-api',
    },
    security: {
      saltRounds: 4,
    },
  ...
  production: {
    ...
    mailer: {
      fromName: process.env.MAILER_FROM || 'jobpicker',
      from: process.env.MAILER_FROM || 'notifications@ocaapp.ch',
      fromName2: process.env.MAILER_FROM || 'jobpicker',
      options: {
        host: 'email-smtp.us-east-2.amazonaws.com',
        port: 587,
        auth: {
